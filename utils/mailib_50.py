...
from utils.mailib_music import total_list, get_cover_len4_id
...
class DrawBest(object):
    ...
    def __init__(self, sdBest: BestList, dxBest: BestList, userName: str):
        ...
        self.pic_dir = 'res/static/mai/pic/'
        self.cover_dir = 'res/static/mai/cover/'
    ...
    def _drawBestList(self, img: Image.Image, sdBest: BestList, dxBest: BestList):
        ...
        titleFontName = 'res/static/adobe_simhei.otf'
        for num in range(0, len(sdBest)):
            ...
            font = ImageFont.truetype('res/static/adobe_simhei.otf', 12, encoding='utf-8')
            tempDraw.text((8, 44), f'Base: {chartInfo.ds} -> {computeRa(chartInfo.ds, chartInfo.achievement)}', 'white',
                          font)
            font = ImageFont.truetype('res/static/adobe_simhei.otf', 18, encoding='utf-8')
    ...
    def draw(self):
        ...
        font1 = ImageFont.truetype('res/static/msyh.ttc', 28, encoding='unic')
        ...
        font2 = ImageFont.truetype('res/static/adobe_simhei.otf', 14, encoding='utf-8')
